...
//Code Here 
const contains = (arr, nam, cb) => arr.indexOf(nam) >= 0 ? cb(true) : cb(false);
// Do not edit the code below.
...
//Code Here 
const each = (a, cb) => a.forEach(x => cb(x, a.indexOf(x)));
// Do not edit the code below.
